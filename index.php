		...
		<header>
		  <div class="profile-page sidebar-collapse">
			<nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
			  <div class="container">
				<div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Accueil</a>
		...
		<div class="page-header page-header-small" filter-color="green">
		  ...
		  <div class="container">
			<div class="content-center">
			  ...
			  <div class="h2 title">Nassim Azi</div>
			  <p class="category text-white">Dévloppeur Web - Master en Réseaux </p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Me contacter</a><a class="btn btn-primary" href="CV AZI NASSIM.pdf" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
			</div>
		  </div>
		  <div class="section">
			<div class="container">
			  <div class="button-container"><a class="btn btn-default btn-round btn-lg btn-icon" href="https://www.facebook.com/nassim.azi.7" rel="tooltip" title="Suivez moi sur Facebook"><i class="fa fa-facebook"></i></a><a class="btn btn-default btn-round btn-lg btn-icon" href="#" rel="tooltip" title="Follow me on Twitter"><i class="fa fa-twitter"></i></a><a class="btn btn-default btn-round btn-lg btn-icon" href="#" rel="tooltip" title="Follow me on Google+"><i class="fa fa-linkedin"></i></a><a class="btn btn-default btn-round btn-lg btn-icon" href="#" rel="tooltip" title="Follow me on Instagram"><i class="fa fa-instagram"></i></a></div>
			</div>
		  </div>
		</div>
	  </div>
		  ...
		  <div class="row">
			<div class="col-md-6">
			  <div class="card-body">
				...
				<p>Bonjour! je suis Nassim Azi. .</p>
				<p>Diplômé d'un master en administration et sécurité des réseaux et d'une licence en mathématiques et informatique de l'université de Bejaia.
	<br> passionné par le développement d'applications j'ai programmé avec plusieurs langages (HTML/Css, PHP, Java EE, Android...) en suivant le langage de modélisation unifié (UML). <a href="https://templateflip.com/templates/creative-cv/" target="_blank">Learn More</a></p>
			  </div>
			</div>
			<div class="col-md-6">
			  <div class="card-body">
				...
				<div class="row mt-3">
				  ...
				  <div class="col-sm-8">azinassim.a@gmail.com</div>
				</div>
				<div class="row mt-3">
				  <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
				  <div class="col-sm-8">+213 669 896 959</div>
				</div>
				<div class="row mt-3">
				  <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
				  <div class="col-sm-8">Akhenak 06099, Seddouk, Béjaia , Algérie</div>
				</div>
				<div class="row mt-3">
	  ...
	  <div class="container">
		...
		<div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
		  <div class="card-body">
			...
			<div class="row">
			  <div class="col-md-6">
				<div class="progress-container progress-primary"><span class="progress-badge">Java/JavaEE</span>
				  <div class="progress">
			  ...
			  <div class="col-md-6">
				<div class="progress-container progress-primary"><span class="progress-badge">Android</span>
				  <div class="progress">
					<div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 50%;"></div><span class="progress-value"></span>
				  </div>
				</div>
			  </div>
			</div>
			...
			<div class="row">
			  ...
			  <div class="col-md-6">
				<div class="progress-container progress-primary"><span class="progress-badge">Xml</span>
				  <div class="progress">
					<div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"></div><span class="progress-value"></span>
				  </div>
				</div>
	  ...
	  <div class="container">
		<div class="row">
		  ...
		  <div class="col-md-6 ml-auto mr-auto">
			<div class="h4 text-center mb-4 title">Projets Réalisés</div>
			<div class="nav-align-center">
			  <ul class="nav nav-pills nav-pills-primary" role="tablist">
				<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#web-development" role="tablist"><i class="fa fa-file-code-o" aria-hidden="true"></i></a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#graphic-design" role="tablist"><i class="fa fa-volume-control-phone" aria-hidden="true"></i></a></li>
				  ...
				  <div class="col-md-6">
					<div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
						<figure class="cc-effect"><img src="images/project-3.jpg"/>
						  <figcaption>
							<div class="h4">Application de géolocalisation</div>
							<p>géolocalisation des camions</p>
							<div class="container">
							  <button class="btn btn-simple" href="#">Learn More</button>
							</div>
						  </figcaption>
						</figure></a></div>
				...
				<div class="row">
				  <div class="col-md-6">
					<div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
						<figure class="cc-effect"><img src="images/voip.jpg"/>
						  <figcaption>
							<div class="h4">Téléphonie sur Ip</div>
							<p>Réalisation d'une solution téléphonie sur Ip (VOIP)</p>
							<div class="container">
							  <button class="btn btn-simple" href="#">Learn More</button>
							</div>
						  </figcaption>
	  ...
	  <div class="container cc-education">
		  ...
		  <div class="row">
			<div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
			  <div class="card-body cc-education-header">
				<p>2014 - 2016</p>
				<div class="h5">Master</div>
			  </div>
			</div>
			<div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
			  <div class="card-body">
				<div class="h5">Master Administration et sécurité des réseaux  </div>
				<p class="category">Université Abderrahmane Mira - Bejaia - Algérie </p>
				<p> </p>
			  </div>
			</div>
		  </div>
		...
		<div class="card">
		  <div class="row">
			...
			<div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
			  <div class="card-body">
				<div class="h5">Licence Mathématique et Informatique</div>
				<p class="category">Université Abderrahmane Mira - Bejaia - Algérie</p>
				<p> </p>
			  </div>
			</div>
		...
		<div class="card">
		  <div class="row">
			...
			<div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
			  <div class="card-body">
				<div class="h5">Baccalauréat série Mathématiques</div>
				<p class="category">lycée de seddouk</p>
				<p></p>
			  </div>
			</div>
		  </div>
		...
		<div class="card">
		  <div class="row">
			<div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
			  <div class="card-body cc-education-header">
				<p>Octobre 2015</p>
				<div class="h5">DELF B2</div>
			  </div>
			</div>
			<div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
			  <div class="card-body">
				<div class="h5">Diplome d'Etude en Langue Francaise </div>
				<p class="category">Institut Française d'alger</p>
				<p></p>
			  </div>
			</div>
		  </div>
	...
	<div class="section" id="reference">
	  <div class="container cc-reference">
		<div class="h4 mb-4 text-center title">Centres d'Intérêt</div>
			  ...
			  <div class="carousel-item active">
				<div class="row">
				  <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/reference-image-1.jpg"/>
					<div class="h5 pt-2">Trésorier</div>
					<p class="category">AC TALWIT</p>
				  </div>
				  <div class="col-lg-10 col-md-9">
					<p><br><br>Membre de l'association culturelle TALWIT du village Akhenak de 2011 à 2017. Je me suis occupé de plusieurs taches et j'ai été chef de plusieurs projets associatifs (club audiovisuel, lutte contre la drogue...).</p>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="carousel-item">
				<div class="row">
				  <div class="col-lg-2 col-md-3 cc-reference-header"><img src="images/reference-image-2.jpg"/>
					<div class="h5 pt-2">S. Général </div>
					<p class="category">RSC Akhenak</p>
				  </div>
				  <div class="col-lg-10 col-md-9">
				  <p> <br><br><br>Secrétaire général du club sportif amateur Racing sportif club Akhenak (RSCA) de 2016 à ce jour.
				  </p>
				  </div>
				</div>
			  </div>
...
if (isset($_POST["email"])) {
	$destinataire = 'azinassim.a@gmail.com';
    ...
    else // Non envoyé
    {
        echo '<script languag="javascript">alert("Votre message n\'a pas pu être envoyé");</script>';
					...
					<div class="col-md-6">
					  <div class="card-body">
						...
						<p class="pb-2">Akhenak 06099, Seddouk, Béjaia, Algérie.</p>
						<p class="mb-0"><strong>Téléphone</strong></p>
						<p class="pb-2">+213 669 896 959</p>
						<p class="mb-0"><strong>Email</strong></p>
						<p>azinassim.a@gmail.com</p>
					  </div>
					</div>
				  </div>
				</div>
		...
		<footer class="footer">
		  <div class="container">
			<div class="text-center"><a class="cc-facebook btn btn-link" href="#"><i class="fa fa-facebook fa-2x " aria-hidden="true"></i></a><a class="cc-twitter btn btn-link " href="#"><i class="fa fa-twitter fa-2x " aria-hidden="true"></i></a><a class="cc-google-plus btn btn-link" href="#"><i class="fa fa-google-plus fa-2x" aria-hidden="true"></i></a><a class="cc-instagram btn btn-link" href="#"><i class="fa fa-instagram fa-2x " aria-hidden="true"></i></a></div>
			<div class="h4 title text-center">Nassim Azi</div>
